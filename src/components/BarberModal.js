...
const UserAvatarModal = styled.Image`
    width: 56px;
    height: 56px;
    border-radius: 20px;
    margin-right: 15px;
        ...
        <Modal 
            ...
            <ModalArea>
                <ModalBody>
                    ...
                    <ModalItem>
                        <UserInfo>
                            <UserAvatarModal source={{uri: user.avatar}} />
                        ...
                        >
                            {listDays.map((item, key)=>(
                                <DateItem key={key} onPress={()=>{ item.status ? setSelectedDay(item.number) : null }} style={{
                                    ...
                                    backgroundColor: item.number === selectedDay ? '#C1660B' : '#FFFFFF'
                                }}>
                        ...
                        <ModalItem>
                            ...
                            >
                                {listHours.map((item, key)=>(
                                    <TimeItem key={key} onPress={()=>setSelectedHour(item)} style={{
                                        backgroundColor: item === selectedHour ? '#C1660B' : '#FFFFFF'
                                    }}>
                                        <TimeItemText style={{
                    ...
                    <FinishButton onPress={handleFinishButtonClick}>
